...
서울시 개방·공중화장실 4,447곳을 지도에 표시하고, 현재 위치에서 가까운 화장실의 도보 길찾기를 연결하는 풀스택 웹사이트입니다. 기존에 자동차 번호판을 입력하면 차량의 정보를 보여주는 사이트로 구상하였지만, API가 유료여서 공중 화장실을 빠르게 찾을 수 있는 사이트로 바꾸었습니다.
